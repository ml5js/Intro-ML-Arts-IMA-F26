...
2. Coding: Reading line by line in the 4 "Training Image Classifiers" [examples](https://github.com/ml5js/Intro-ML-Arts-IMA-F26/tree/main/08-cnn#training-image-classifiers), build on top of any of the 4 examples
3. Add a link to the post and your p5.js sketch on the [Assignment 8](https://github.com/ml5js/Intro-ML-Arts-IMA-F26/wiki/Assignment-8) Wiki page.
