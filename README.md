# Introduction to Machine Learning for the Arts - Fall 2026
...
- 370 Jay Street, Room 411, Brooklyn Campus
...
### 1: [Introduction](01-introduction) (9/4)

### 2: [Transfer Learning](02-transfer-learning) (9/11)

### 3: [Pre-trained models 1: Body](03-body-models) (9/18)

### 4: [Hand Models](04-hand-models) (9/25)

### 5: [Face Models](05-face-modals) (10/2)

### 6: [Sound Classifier](06-sound-classifier) (10/9)

### 7: [Training a Neural Network 2](07-neural-networks) (10/16)

### 8: [Convolutional Neural Networks (CNN)](08-cnn) (10/23)

### 9: [Text and Language Models](09-llms) (10/30)

### 10: [Image Generation Models](10-image-models) (11/6)

### 11: [Final Project Proposals](final) (11/13)

### 12: [Final Project Work session](final) + Runway [workflow](https://academy.runwayml.com/workflows/using-workflows) + Gemini Nano banana 3, [doc](https://ai.google.dev/gemini-api/docs/image-generation), [sketch](https://github.com/ml5js/Intro-ML-Arts-IMA-F26/blob/main/10-image-models/README.md#code-examples-and-implementations) Workshop (11/20)

### 13: [Final Project Play Testing](final) (11/25 Wednesday)

### 14: [Final Project Presentations](final) (12/4)
...
This syllabus is adapted from the work of previous instructors—[Daniel Shiffman (Fall 2023)](https://github.com/ml5js/Intro-ML-Arts-IMA-F23), [Jack Du (Summer 2024)](https://jackbdu.com/Intro-ML-Arts-IMA-Summer24/), and [Yining Shi (Fall 2025)](https://github.com/ml5js/Intro-ML-Arts-IMA-F25)—who have generously shared their materials. Thank you also to Gottfried Haider, his course materials for Machine Learning for Artists and Designers also served as a foundation for the materials presented here.
